...
@RestController
@RequestMapping("/api/prueba-poc-jhipster-aaa-kafka")
public class PruebaPocJhipsterAaaKafkaResource {
    private final Logger log = LoggerFactory.getLogger(PruebaPocJhipsterAaaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PruebaPocJhipsterAaaKafkaResource(KafkaProperties kafkaProperties) {
