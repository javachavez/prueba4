package com.jubotours.prueba.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("pruebaPocJhipsterAAA");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("pruebaPocJhipsterAAA");
        ...
        config.getMapConfigs().put("com.jubotours.prueba.domain.*", initializeDomainMapConfig(jHipsterProperties));
