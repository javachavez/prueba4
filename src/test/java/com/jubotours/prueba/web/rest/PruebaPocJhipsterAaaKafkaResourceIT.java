package com.jubotours.prueba.web.rest;
...
import com.jubotours.prueba.config.KafkaProperties;
...
class PruebaPocJhipsterAaaKafkaResourceIT {
    ...
    void setup() {
        ...
        PruebaPocJhipsterAaaKafkaResource kafkaResource = new PruebaPocJhipsterAaaKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/prueba-poc-jhipster-aaa-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/prueba-poc-jhipster-aaa-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
